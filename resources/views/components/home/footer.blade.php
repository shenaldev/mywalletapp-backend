<footer class="border-t border-primary/10 bg-ink text-white pt-16 pb-8">
    <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5">
                    ...
                    <li><a href="#download" class="text-sm text-white/50 hover:text-white transition-colors">Download
                            App</a></li>
                    <li><a href="#how" class="text-sm text-white/50 hover:text-white transition-colors">How It
                            Works</a></li>
                    <li><a href="{{ env('FRONTEND_URL') }}"
                            class="text-sm text-white/50 hover:text-white transition-colors">Launch
                            Web App</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5">
                    <li><a href="{{ route('terms-conditions') }}"
                            class="text-sm text-white/50 hover:text-white transition-colors">Terms &
                            Conditions</a></li>
        ...
        <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p class="text-sm text-white/40">Built with <span class="text-primary">❤</span> by <a
                    href="https://shenaldev.com" class="hover:text-white transition-colors font-medium">ShenalDEV</a>
            </p>
        </div>
    </div>
</footer>
